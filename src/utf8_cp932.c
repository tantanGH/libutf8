...
//  utf-8 to cp932
//
void utf8_to_cp932(uint8_t* cp932_buffer, size_t cp932_buffer_bytes, uint8_t* utf8_buffer, size_t utf8_buffer_bytes) {
  ...
  while (utf8_ofs < utf8_buffer_bytes && (cp932_ofs+2) < cp932_buffer_bytes) {
